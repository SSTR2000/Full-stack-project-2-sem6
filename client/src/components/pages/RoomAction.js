            ...
            <div className="mid container">
                ...
                <form onSubmit={this.onSubmit}>
                    <div className="row">
                        ...
                        <div className="col">
                            <label htmlFor="ex2">Grievance</label>
                        ...
                        <div className="col">
                            ...
                            <input type="text" id="time" placeholder="date/time(AM/PM)"
                                className={classnames("form-control", {
                        ...
                        <div className="col">
                            <label htmlFor="incharge">PG Incharge</label>
                            <input type="text" id="incharge" placeholder="Name"
                                className={classnames("form-control", {
                        ...
                        <div className="col">
                            <label htmlFor="exampleFormControlSelect1">Resident Gender</label>
                            <select className={classnames("form-control", {
